...
- **[iris-devtester-containers](../iris-devtester-containers/SKILL.md)** — `IRISContainer` factory patterns, CPF-first startup, graceful shutdown.
- **[iris-devtester-connections](../iris-devtester-connections/SKILL.md)** — `IRISConnectionInfo`, `to_toml_snippet()`, the iris-agentic-dev handoff, connection validation.
...
Deeper container patterns (editions, attach, CPF-first startup, graceful shutdown) live in **[iris-devtester-containers](../iris-devtester-containers/SKILL.md)**.
...
Connection metadata, validation, and the iris-agentic-dev handoff live in **[iris-devtester-connections](../iris-devtester-connections/SKILL.md)**.
