...
### 9. AUTHORSHIP AND ATTRIBUTION

**The Principle**: All code, documentation, and commits are authored by Thomas Dyar (thomas.dyar@intersystems.com). Never attribute work to AI assistants.

**Why It Matters**:
- Clear ownership and accountability
- Professional representation
- Consistent project identity
- Simplified legal and licensing considerations

**Implementation Requirements**:
- ✅ All commits use Thomas Dyar as author
- ✅ No "Generated by AI" or "Co-authored by AI" attributions
- ✅ Documentation credits Thomas Dyar as author/maintainer
- ✅ Copyright notices reference Thomas Dyar or InterSystems

**Forbidden**:
- ❌ "Generated with Claude Code" or similar AI tool attribution
- ❌ "Co-Authored-By: Claude" or any AI assistant
- ❌ AI tool badges or mentions in README
...
### v1.1.0 (2025-12-17)
- Added Principle #9: Authorship and Attribution
- Clear ownership: Thomas Dyar (thomas.dyar@intersystems.com)
